...
namespace BLL
{
	...
	/// 产线不生产钢种
	/// </summary>
	public partial class Bll_TPB_N_GRD
    {
        private readonly Dal_TPB_N_GRD dal = new Dal_TPB_N_GRD();
        public Bll_TPB_N_GRD()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TPB_N_GRD> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TPB_N_GRD> DataTableToList(DataTable dt)
        {
            List<Mod_TPB_N_GRD> modelList = new List<Mod_TPB_N_GRD>();
