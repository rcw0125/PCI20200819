...
namespace BLL
{
    ...
    public partial class Bll_TPP_INITIALIZE_ORDER
    {
        ...
        {
            return dal.Get_Order_LGPCSUM(strIniID, strGZ, strBZ, strCCMID, ccmtype);
        }
        /// <summary>
        /// 得到已初始化订单信息
        /// </summary>
        ...
        {
            return dal.ROLLGetIniOrderByIniID(strIniID, strGZ, strBZ,C_SPEC1, C_SPEC2, strRollID, rolltype);
        }
