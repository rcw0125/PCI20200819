...
namespace BLL
{
    ...
    /// 取样明细模板
    /// </summary>
    public partial class Bll_TQB_SAMP_ITEM_MODLE
    {
        private readonly Dal_TQB_SAMP_ITEM_MODLE dal = new Dal_TQB_SAMP_ITEM_MODLE();
        public Bll_TQB_SAMP_ITEM_MODLE()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TQB_SAMP_ITEM_MODLE> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TQB_SAMP_ITEM_MODLE> DataTableToList(DataTable dt)
        {
            List<Mod_TQB_SAMP_ITEM_MODLE> modelList = new List<Mod_TQB_SAMP_ITEM_MODLE>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Mod_TQB_SAMP_ITEM_MODLE model;
        ...
        {
            return dal.Get_ITEM_List(C_STD_CODE, C_STL_GRD, C_SPEC);
        }
