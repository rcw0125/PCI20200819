...
namespace BLL
{
    ...
    /// 取样模板
    /// </summary>
    public partial class Bll_TQB_SAMP_MODLE
    {
        private readonly Dal_TQB_SAMP_MODLE dal = new Dal_TQB_SAMP_MODLE();
        public Bll_TQB_SAMP_MODLE()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TQB_SAMP_MODLE> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Mod_TQB_SAMP_MODLE> DataTableToList(DataTable dt)
        {
            List<Mod_TQB_SAMP_MODLE> modelList = new List<Mod_TQB_SAMP_MODLE>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Mod_TQB_SAMP_MODLE model;
        ...
        public string Save_Modle(DataTable dt)
        {
            try
            {
                ...
                Dal_TQB_SAMP_ITEM_MODLE dalTqbItem = new Dal_TQB_SAMP_ITEM_MODLE();
                ...
                for (int irow = 0; irow < dt.Rows.Count; irow++)
                {
                    ...
                    i_ID++;
                    Mod_TQB_SAMP_MODLE modMain = new Mod_TQB_SAMP_MODLE();
                    ...
                    modMain.N_SAM_NUM = Convert.ToDecimal(dt.Rows[irow]["取样数量"].ToString());
