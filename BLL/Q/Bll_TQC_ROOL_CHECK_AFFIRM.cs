...
namespace BLL
{
	...
	/// 线材库检确认
	/// </summary>
	public partial class Bll_TQC_ROOL_CHECK_AFFIRM
	{
		private readonly Dal_TQC_ROOL_CHECK_AFFIRM dal=new Dal_TQC_ROOL_CHECK_AFFIRM();
		public Bll_TQC_ROOL_CHECK_AFFIRM()
		{}
		#region  BasicMethod
		/// <summary>
		/// 是否存在该记录
		...
		/// 获得数据列表
		/// </summary>
		public List<Mod_TQC_ROOL_CHECK_AFFIRM> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Mod_TQC_ROOL_CHECK_AFFIRM> DataTableToList(DataTable dt)
		{
			List<Mod_TQC_ROOL_CHECK_AFFIRM> modelList = new List<Mod_TQC_ROOL_CHECK_AFFIRM>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Mod_TQC_ROOL_CHECK_AFFIRM model;
