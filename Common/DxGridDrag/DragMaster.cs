...
namespace Common
{
    public class DragMaster
    {
        ...
        static Cursor CustomizationCursor
        {
            get
            {
                if (customizationCursor == null)
                    customizationCursor = Cursors.UpArrow;// ResourceImageHelper.CreateCursorFromResources("DevExpress.XtraTreeList.Images.customization.cur", typeof(DragMaster).Assembly);
