...
namespace DAL
{
	...
	/// 数据访问类:TB_LOG
	/// </summary>
	public partial class Dal_TB_LOG
	{
		public Dal_TB_LOG()
		{}
		#region  BasicMethod
		...
		public bool Add(Mod_TB_LOG model)
		{
			...
			strSql.Append("C_IP,C_MODULES,C_MENU_NAME,C_FORMS_NAME,C_FORMS_DESC,C_OPER_CONTEXT,N_STATUS,C_REMARK,C_EMP_ID)");
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TB_LOG DataRowToModel(DataRow row)
		{
			Mod_TB_LOG model=new Mod_TB_LOG();
			if (row != null)
			{
