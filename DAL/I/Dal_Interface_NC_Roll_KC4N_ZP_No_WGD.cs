...
namespace DAL
{
    public partial class Dal_Interface_NC_Roll_KC4N_ZP_No_WGD
    {
        ...
        /// <returns></returns>
        public string SendXml_GP(string xmlFileName, string strBatchNo, string C_MASTER_ID, string C_MAT_CODE, string strWgt, string strQua, string strZYX1, string strZYX2, string C_GP_BEFORE_ID)
        {
            try
            {
                ...
                Mod_TQB_CHECKSTATE mod_checkstate = dal_checkstate.GetModelByName_Trans("DP", "1001");//判定等级
                ...
                Mod_TRC_ROLL_PRODCUT modPro = dal_roll_pro.GetModelByBatch(strBatchNo);
                if (modPro == null) return "获取实绩信息错误!";
                ...
                CreateNode(xmlDoc, item, "scrq", Convert.ToDateTime(modPro.D_WEIGHT_DT).ToString("yyyy-MM-dd"));
                ...
                CreateNode(xmlDoc, item, "vfree3", modPro.C_BZYQ);
                ...
                CreateNode(xmlDoc, item, "ts", modPro.D_WEIGHT_DT.ToString());
                CreateNode(xmlDoc, item, "timestamp", "");
                CreateNode(xmlDoc, item, "bodyts", modPro.D_WEIGHT_DT.ToString());
                ...
                CreateNode(xmlDoc, item, "vnote", "");//备注
                CreateNode(xmlDoc, item, "tchecktime", modPro.D_WEIGHT_DT.ToString());
                ...
                {
                    Mod_TQB_CHECKSTATE mod_Lev = dal_checkstate.GetModelByName_Trans(dt_sj_list.Rows[i]["C_JUDGE_LEV_ZH"].ToString(), "1001");//判定等级
                    ...
                    CreateNode(xmlDoc, item_gp, "scrq", Convert.ToDateTime(modPro.D_WEIGHT_DT.ToString()).ToString("yyyy-MM-dd"));
                    ...
                    CreateNode(xmlDoc, item_gp, "vfree3", modPro.C_BZYQ);
