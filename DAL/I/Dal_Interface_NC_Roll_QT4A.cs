...
namespace DAL
{
    public partial class Dal_Interface_NC_Roll_QT4A
    {
        private Dal_Send_NC SendNC = new Dal_Send_NC();
        Dal_TRC_ROLL_QTCKD dal_TRC_ROLL_QTCKD = new Dal_TRC_ROLL_QTCKD();
        Dal_TRC_ROLL_QTCKD_ITEM dal_TRC_ROLL_QTCKD_ITEM = new Dal_TRC_ROLL_QTCKD_ITEM();
