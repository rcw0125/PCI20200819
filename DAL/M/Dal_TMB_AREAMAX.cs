...
namespace DAL
{
	...
	public partial class Dal_TMB_AREAMAX
	{
		...
		public bool Add(Mod_TMB_AREAMAX model)
		{
			...
			strSql.Append("C_ID,C_CODE,C_NAME,C_REMARK,N_STATUS,C_EMP_ID,C_EMP_NAME,D_MOD_DT)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_CODE,C_NAME,C_REMARK,N_STATUS,C_EMP_ID,C_EMP_NAME,D_MOD_DT ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TMB_AREAMAX";
