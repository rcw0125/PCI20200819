...
namespace DAL
{
    ...
    public partial class Dal_TMP_DAYPLAN
    {
        ...
        public bool Add(Mod_TMP_DAYPLAN model)
        {
            ...
            strSql.Append("C_PLCODE,C_PKBILLB,C_PKBILLH,C_CONNO,C_ORDERNO,C_PKINV,C_PKASSISTMEASURE,N_ASSISTNUM,N_NUM,N_UNITPRICE,N_MONEY,D_PLANDATE,D_ORDSNDATE,D_REQUIREDATE,D_SNDDATE,C_PKCUST,C_PKSENDTYPE,C_PKSALECORP,C_PKSALEORG,C_PKSENDSTOREORG,C_PKOPERATOR,C_PKOPRDEPART,C_PKPLANPERSON,C_PKAPPRPERSON,D_APPRDATE,C_PKARRIVEAREA,C_DESTADDRESS,C_RECEIPTCORPID,C_BIZTYPE,C_REMARK,C_PKSENDAREA,C_PKDELIVORG,C_UNITID,C_VFREE1,C_VFREE2,C_VFREE3,C_VFREE4,C_SALECODE,N_EXEC_STATUS)");
            ...
            OracleParameter[] parameters = {
                    ...
                    new OracleParameter(":N_ASSISTNUM", OracleDbType.Int16,15),
                    new OracleParameter(":N_NUM", OracleDbType.Int16,15),
                    new OracleParameter(":N_UNITPRICE", OracleDbType.Int16,15),
                    new OracleParameter(":N_MONEY", OracleDbType.Int16,15),
                    ...
                    new OracleParameter(":C_SALECODE", OracleDbType.Varchar2,100),
            ...
            parameters[37].Value =  model.C_SALECODE;
        ...
        public bool Update(Mod_TMP_DAYPLAN model)
        {
            ...
            strSql.Append("C_SALECODE=:C_SALECODE,");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TMP_DAYPLAN GetModel(string C_ID)
        {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TMP_DAYPLAN T ");
