...
namespace DAL
{
    ...
    /// 数据访问类:TPA_DHL_PLAN
    /// </summary>
    public partial class Dal_TPA_DHL_PLAN
	{
		public Dal_TPA_DHL_PLAN()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TPA_DHL_PLAN");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_TPA_DHL_PLAN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPA_DHL_PLAN(");
			strSql.Append("C_ID,C_FK,C_STOVE_NO,C_STL_GRD,C_STD_CODE,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,N_HL_TIME,D_PLAN_DATE,C_HLYQ,C_REMARK,N_STATUS,C_CCM,N_QUA,N_CAP,N_TOTAL_QUA,D_START_TIME_SJ,D_END_TIME_SJ,N_QUA_SJ,C_WH_CODE_SJ,N_NUM,D_OVER_TIME)");
			...
			parameters[23].Value = model.D_OVER_TIME;
        ...
        /// 增加一条数据
        /// </summary>
        public bool TranAdd(Mod_TPA_DHL_PLAN model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TPA_DHL_PLAN(");
            strSql.Append("C_ID,C_FK,C_STOVE_NO,C_STL_GRD,C_STD_CODE,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,N_HL_TIME,D_PLAN_DATE,C_HLYQ,C_REMARK,N_STATUS,C_CCM,N_QUA,N_CAP,N_TOTAL_QUA,D_START_TIME_SJ,D_END_TIME_SJ,N_QUA_SJ,C_WH_CODE_SJ,N_NUM,D_OVER_TIME)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Mod_TPA_DHL_PLAN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPA_DHL_PLAN set ");
			...
			parameters[21].Value = model.N_NUM;
        ...
        public bool DeleteByJcID(string C_FK)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TPA_DHL_PLAN ");
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_DHL_PLAN GetModel(string C_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_FK,C_STOVE_NO,C_STL_GRD,C_STD_CODE,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,N_HL_TIME,D_PLAN_DATE,C_HLYQ,C_REMARK,N_STATUS,C_CCM,N_QUA,N_CAP,N_TOTAL_QUA,D_START_TIME_SJ,D_END_TIME_SJ,N_QUA_SJ,C_WH_CODE_SJ,N_NUM,D_OVER_TIME from TPA_DHL_PLAN ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)			};
			parameters[0].Value = C_ID;

			Mod_TPA_DHL_PLAN model=new Mod_TPA_DHL_PLAN();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_DHL_PLAN DataRowToModel(DataRow row)
		{
			Mod_TPA_DHL_PLAN model=new Mod_TPA_DHL_PLAN();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_FK,C_STOVE_NO,C_STL_GRD,C_STD_CODE,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,N_HL_TIME,D_PLAN_DATE,C_HLYQ,C_REMARK,N_STATUS,C_CCM,N_QUA,N_CAP,N_TOTAL_QUA,D_START_TIME_SJ,D_END_TIME_SJ,N_QUA_SJ,C_WH_CODE_SJ,N_NUM,D_OVER_TIME ");
			strSql.Append(" FROM TPA_DHL_PLAN ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPA_DHL_PLAN T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPA_DHL_PLAN";
