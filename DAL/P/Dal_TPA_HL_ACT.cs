...
namespace DAL
{
    ...
    /// 数据访问类:TPA_HL_ACT
    /// </summary>
    public partial class Dal_TPA_HL_ACT
	{
		public Dal_TPA_HL_ACT()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TPA_HL_ACT");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPA_HL_ACT(");
			strSql.Append("C_ID,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,C_REMARK,N_STATUS,N_CAP_QUA,N_QUA,N_SORT)");
			...
			OracleParameter[] parameters = {
					...
					new OracleParameter(":N_CAP_QUA", OracleDbType.Decimal,5),
					new OracleParameter(":N_QUA", OracleDbType.Decimal,5),
					new OracleParameter(":N_SORT", OracleDbType.Decimal,5)};
			parameters[0].Value = model.C_ID;
			parameters[1].Value = model.C_WH_CODE;
			parameters[2].Value = model.C_SLAB_TYPE;
			parameters[3].Value = model.D_START_TIME;
			parameters[4].Value = model.D_END_TIME;
			parameters[5].Value = model.C_REMARK;
			parameters[6].Value = model.N_STATUS;
			parameters[7].Value = model.N_CAP_QUA;
			parameters[8].Value = model.N_QUA;
			parameters[9].Value = model.N_SORT;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPA_HL_ACT set ");
			...
			strSql.Append("N_CAP_QUA=:N_CAP_QUA,");
			...
			OracleParameter[] parameters = {
					...
					new OracleParameter(":N_SORT", OracleDbType.Decimal,5),
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)};
			parameters[0].Value = model.C_WH_CODE;
			parameters[1].Value = model.C_SLAB_TYPE;
			parameters[2].Value = model.D_START_TIME;
			parameters[3].Value = model.D_END_TIME;
			parameters[4].Value = model.C_REMARK;
			parameters[5].Value = model.N_STATUS;
			parameters[6].Value = model.N_CAP_QUA;
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPA_HL_ACT ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)			};
			parameters[0].Value = C_ID;
		...
		public Mod_TPA_HL_ACT GetModel(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,C_REMARK,N_STATUS,N_CAP_QUA,N_QUA,N_SORT from TPA_HL_ACT ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)			};
			parameters[0].Value = C_ID;

			Mod_TPA_HL_ACT model=new Mod_TPA_HL_ACT();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_HL_ACT DataRowToModel(DataRow row)
		{
			Mod_TPA_HL_ACT model=new Mod_TPA_HL_ACT();
			if (row != null)
			{
				...
				if(row["N_CAP_QUA"]!=null && row["N_CAP_QUA"].ToString()!="")
				{
					model.N_CAP_QUA=decimal.Parse(row["N_CAP_QUA"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_WH_CODE,C_SLAB_TYPE,D_START_TIME,D_END_TIME,C_REMARK,N_STATUS,N_CAP_QUA,N_QUA,N_SORT ");
			strSql.Append(" FROM TPA_HL_ACT ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPA_HL_ACT T ");
