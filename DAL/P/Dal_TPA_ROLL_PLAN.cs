...
namespace DAL
{
    ...
    /// 数据访问类:TPA_ROLL_PLAN
    /// </summary>
    public partial class Dal_TPA_ROLL_PLAN
	{
		public Dal_TPA_ROLL_PLAN()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TPA_ROLL_PLAN");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_TPA_ROLL_PLAN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPA_ROLL_PLAN(");
			strSql.Append("C_ID,C_LINE,C_STL_GRD,C_STD_CODE,C_SPEC,N_WGT,D_PLAN_DATE,D_NEED_DATE,C_REMARK)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Mod_TPA_ROLL_PLAN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPA_ROLL_PLAN set ");
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_ROLL_PLAN DataRowToModel(DataRow row)
		{
			Mod_TPA_ROLL_PLAN model=new Mod_TPA_ROLL_PLAN();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_LINE,C_STL_GRD,C_STD_CODE,C_SPEC,N_WGT,D_PLAN_DATE,D_NEED_DATE,C_REMARK ");
			strSql.Append(" FROM TPA_ROLL_PLAN ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPA_ROLL_PLAN T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPA_ROLL_PLAN";
