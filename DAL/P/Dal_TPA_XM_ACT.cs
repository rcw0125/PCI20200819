...
namespace DAL
{
    ...
    /// 数据访问类:TPA_XM_ACT
    /// </summary>
    public partial class Dal_TPA_XM_ACT
	{
		public Dal_TPA_XM_ACT()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TPA_XM_ACT");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_TPA_XM_ACT model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPA_XM_ACT(");
			strSql.Append("C_ID,C_STOVE_NO,C_STL_GRD,C_STD_CODE,N_WGT,N_ACT_WGT,D_START_TIME,D_END_TIME,N_CN,D_PLAN_DATE,C_XMYQ,C_XM_TYPE,C_REMARK,N_STATUS,C_CCM)");
			...
			parameters[5].Value = model.N_ACT_WGT;
			...
			parameters[10].Value = model.C_XMYQ;
			parameters[11].Value = model.C_XM_TYPE;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Mod_TPA_XM_ACT model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPA_XM_ACT set ");
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPA_XM_ACT ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)			};
			parameters[0].Value = C_ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_XM_ACT GetModel(string C_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_STOVE_NO,C_STL_GRD,C_STD_CODE,N_WGT,N_ACT_WGT,D_START_TIME,D_END_TIME,N_CN,D_PLAN_DATE,C_XMYQ,C_XM_TYPE,C_REMARK,N_STATUS,C_CCM from TPA_XM_ACT ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,50)			};
			parameters[0].Value = C_ID;

			Mod_TPA_XM_ACT model=new Mod_TPA_XM_ACT();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPA_XM_ACT DataRowToModel(DataRow row)
		{
			Mod_TPA_XM_ACT model=new Mod_TPA_XM_ACT();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_STOVE_NO,C_STL_GRD,C_STD_CODE,N_WGT,N_ACT_WGT,D_START_TIME,D_END_TIME,N_CN,D_PLAN_DATE,C_XMYQ,C_XM_TYPE,C_REMARK,N_STATUS,C_CCM ");
			strSql.Append(" FROM TPA_XM_ACT ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPA_XM_ACT T ");
