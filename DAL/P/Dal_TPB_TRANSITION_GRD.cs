...
{
	/// <summary>
	/// 数据访问类:TPB_TRANSITION_GRD
	/// </summary>
	public partial class Dal_TPB_TRANSITION_GRD
    {
		public Dal_TPB_TRANSITION_GRD()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TPB_TRANSITION_GRD");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TPB_TRANSITION_GRD(");
			strSql.Append("C_ID,C_STL_GRD,C_TRANSITION_GRD,N_LEVEL,C_REMARK,N_STATUS,C_EMP_ID,D_MOD_DT,D_START_DATE,D_END_DATE)");
			strSql.Append(" values (");
			strSql.Append(":C_ID,:C_STL_GRD,:C_TRANSITION_GRD,:N_LEVEL,:C_REMARK,:N_STATUS,:C_EMP_ID,:D_MOD_DT,:D_START_DATE,:D_END_DATE)");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100),
					new OracleParameter(":C_STL_GRD", OracleDbType.Varchar2,100),
					new OracleParameter(":C_TRANSITION_GRD", OracleDbType.Varchar2,100),
			...
			parameters[2].Value = model.C_TRANSITION_GRD;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TPB_TRANSITION_GRD set ");
			strSql.Append("C_STL_GRD=:C_STL_GRD,");
			strSql.Append("C_TRANSITION_GRD=:C_TRANSITION_GRD,");
			...
			parameters[1].Value = model.C_TRANSITION_GRD;
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TPB_TRANSITION_GRD ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;
		...
		public Mod_TPB_TRANSITION_GRD GetModel(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_STL_GRD,C_TRANSITION_GRD,N_LEVEL,C_REMARK,N_STATUS,C_EMP_ID,D_MOD_DT,D_START_DATE,D_END_DATE from TPB_TRANSITION_GRD ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;

			Mod_TPB_TRANSITION_GRD model=new Mod_TPB_TRANSITION_GRD();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TPB_TRANSITION_GRD DataRowToModel(DataRow row)
		{
			Mod_TPB_TRANSITION_GRD model=new Mod_TPB_TRANSITION_GRD();
			if (row != null)
			{
				...
				if(row["C_TRANSITION_GRD"]!=null)
				{
					model.C_TRANSITION_GRD=row["C_TRANSITION_GRD"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_STL_GRD,C_TRANSITION_GRD,N_LEVEL,C_REMARK,N_STATUS,C_EMP_ID,D_MOD_DT,D_START_DATE,D_END_DATE ");
			strSql.Append(" FROM TPB_TRANSITION_GRD ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TPB_TRANSITION_GRD T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TPB_TRANSITION_GRD";
