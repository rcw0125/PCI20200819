...
namespace DAL
{
    ...
    /// 数据访问类:TPO_GPKWT_LAB
    /// </summary>
    public partial class Dal_TPO_GPKWT_LAB
    {
        public Dal_TPO_GPKWT_LAB()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_LOC_CODE)
        {
            ...
            strSql.Append("select count(1) from TPO_GPKWT_LAB");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TPO_GPKWT_LAB(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TPO_GPKWT_LAB set ");
        ...
        public bool Delete(string C_LOC_CODE)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TPO_GPKWT_LAB ");
            strSql.Append(" where C_LOC_CODE=:C_LOC_CODE ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_LOC_CODE", OracleDbType.Varchar2,100)         };
            parameters[0].Value = C_LOC_CODE;
        ...
        public Mod_TPO_GPKWT_LAB GetModel(string C_LOC_CODE)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_CODE,C_AREA_CODE,C_LOC_CODE,C_TIER_CODE,C_X_WIRE,C_Y_WIRE,C_LAB_HEIGHT,C_LAB_WIDTH,C_COUNT,C_REMARK,C_EMP_ID,D_MOD_DT from TPO_GPKWT_LAB ");
            strSql.Append(" where C_LOC_CODE=:C_LOC_CODE ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_LOC_CODE", OracleDbType.Varchar2,100)         };
            parameters[0].Value = C_LOC_CODE;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TPO_GPKWT_LAB DataRowToModel(DataRow row)
        {
            Mod_TPO_GPKWT_LAB model = new Mod_TPO_GPKWT_LAB();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM TPO_GPKWT_LAB ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TPO_GPKWT_LAB T ");
        ...
        public DataSet GetList(string c_code, string c_area_code)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_CODE,C_AREA_CODE,C_LOC_CODE,C_TIER_CODE,C_X_WIRE,C_Y_WIRE,C_LAB_HEIGHT,C_LAB_WIDTH,C_COUNT,C_REMARK,C_EMP_ID,D_MOD_DT ");
            strSql.Append(" FROM TPO_GPKWT_LAB where 1=1 ");
