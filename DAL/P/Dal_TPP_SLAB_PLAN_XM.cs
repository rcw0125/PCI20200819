...
{
    /// <summary>
	/// 数据访问类:TPP_SLAB_PLAN_XM
	/// </summary>
	public partial class Dal_TPP_SLAB_PLAN_XM
    {
        public Dal_TPP_SLAB_PLAN_XM()
        { }
        #region  BasicMethod
        ...
        public bool Add(Mod_TPP_SLAB_PLAN_XM model)
        {
            ...
            strSql.Append("insert into TPP_SLAB_PLAN_XM(");
            strSql.Append("C_ID,C_STA_ID,C_XM_DESC,C_PLAN_ID,C_STL_GRD,C_SPEC,N_LTH,C_STD_CODE,N_QTY,N_WGT,D_PLAN_DT,D_PLAN_START,D_PLAN_END,N_STATUS,N_ACT_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK,N_ACT_QTY)");
            strSql.Append(" values (");
            strSql.Append(":C_ID,:C_STA_ID,:C_XM_DESC,:C_PLAN_ID,:C_STL_GRD,:C_SPEC,:N_LTH,:C_STD_CODE,:N_QTY,:N_WGT,:D_PLAN_DT,:D_PLAN_START,:D_PLAN_END,:N_STATUS,:N_ACT_STATUS,:C_EMP_ID,:D_MOD_DT,:C_REMARK,:N_ACT_QTY)");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100),
                    new OracleParameter(":C_STA_ID", OracleDbType.Varchar2,100),
                    new OracleParameter(":C_XM_DESC", OracleDbType.Varchar2,100),
            ...
            parameters[2].Value = model.C_XM_DESC;
            ...
            parameters[8].Value = model.N_QTY;
        ...
        public bool Update(Mod_TPP_SLAB_PLAN_XM model)
        {
            ...
            strSql.Append("C_XM_DESC=:C_XM_DESC,");
        ...
        public bool Delete()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TPP_SLAB_PLAN_XM ");
            strSql.Append(" where ");
            OracleParameter[] parameters = {
            };
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TPP_SLAB_PLAN_XM GetModel()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STA_ID,C_XM_DESC,C_PLAN_ID,C_STL_GRD,C_SPEC,N_LTH,C_STD_CODE,N_QTY,N_WGT,D_PLAN_DT,D_PLAN_START,D_PLAN_END,N_STATUS,N_ACT_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK,N_ACT_QTY from TPP_SLAB_PLAN_XM ");
            strSql.Append(" where ");
            OracleParameter[] parameters = {
            };

            Mod_TPP_SLAB_PLAN_XM model = new Mod_TPP_SLAB_PLAN_XM();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TPP_SLAB_PLAN_XM DataRowToModel(DataRow row)
        {
            Mod_TPP_SLAB_PLAN_XM model = new Mod_TPP_SLAB_PLAN_XM();
            if (row != null)
            {
                ...
                if (row["C_XM_DESC"] != null)
                {
                    model.C_XM_DESC = row["C_XM_DESC"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STA_ID,C_XM_DESC,C_PLAN_ID,C_STL_GRD,C_SPEC,N_LTH,C_STD_CODE,N_QTY,N_WGT,D_PLAN_DT,D_PLAN_START,D_PLAN_END,N_STATUS,N_ACT_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK,N_ACT_QTY ");
            strSql.Append(" FROM TPP_SLAB_PLAN_XM ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM TPP_SLAB_PLAN_XM ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TPP_SLAB_PLAN_XM T ");
