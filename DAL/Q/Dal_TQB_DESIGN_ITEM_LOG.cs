...
{
    /// <summary>
    /// 数据访问类:TQB_DESIGN_ITEM_LOG
    /// </summary>
    public partial class Dal_TQB_DESIGN_ITEM_LOG
	{
		public Dal_TQB_DESIGN_ITEM_LOG()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TQB_DESIGN_ITEM_LOG");
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TQB_DESIGN_ITEM_LOG ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TQB_DESIGN_ITEM_LOG ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList_Query(string C_DESIGN_NO)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  b.c_code,b.c_name,T.C_ID,t.C_DESIGN_ID,t.C_CHARACTER_ID,t.C_TARGET_MIN,t.C_TARGET_INTERVAL,t.C_TARGET_MAX,t.C_PREWARNING_VALUE,t.C_TYPE,t.C_IS_DECIDE,t.C_IS_PRINT,t.N_PRINT_ORDER,t.N_SPEC_MIN,t.C_SPEC_INTERVAL,t.N_SPEC_MAX,t.C_FORMULA,t.C_UNIT,t.N_DIGIT,t.C_QUANTITATIVE,t.C_TEST_TEM,t.C_TEST_CONDITION,t.N_STATUS,t.C_REMARK,t.C_EMP_ID,t.D_MOD_DT  ");
            strSql.Append(" FROM TQB_DESIGN_ITEM_LOG T JOIN TQB_DESIGN T1 ON T.C_DESIGN_ID=T1.C_ID  inner join tqb_character b on t.c_character_id = b.c_id inner join tqb_checktype c on b.c_type_id=c.c_id WHERE T.N_STATUS=1 and t.c_type='成分' ");
            if (C_DESIGN_NO.Trim() != "")
            {
                strSql.Append("  AND  T1.C_DESIGN_NO = '" + C_DESIGN_NO + "' ");
            }
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TQB_DESIGN_ITEM_LOG T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TQB_DESIGN_ITEM_LOG";
