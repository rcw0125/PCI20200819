...
{
    /// <summary>
    /// 数据访问类:TQB_SAMP_ITEM_MODLE_JSZX
    /// </summary>
    public partial class Dal_TQB_SAMP_ITEM_MODLE_JSZX
    {
        public Dal_TQB_SAMP_ITEM_MODLE_JSZX()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TQB_SAMP_ITEM_MODLE_JSZX");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add_Trans(Mod_TQB_SAMP_ITEM_MODLE_JSZX model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TQB_SAMP_ITEM_MODLE_JSZX(");
            strSql.Append("C_SAMP_MODLE_ID,C_SAMPLES_ID,C_SAM_NUM,N_STATUS,C_EMP_ID,D_MOD_DT,C_SAMPLES_NAME)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TQB_SAMP_ITEM_MODLE_JSZX set ");
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TQB_SAMP_ITEM_MODLE_JSZX ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)         };
            parameters[0].Value = C_ID;
        ...
        public Mod_TQB_SAMP_ITEM_MODLE_JSZX GetModel(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_SAMP_MODLE_ID,C_SAMPLES_ID,C_SAM_NUM,N_STATUS,C_EMP_ID,D_MOD_DT,C_SAMPLES_NAME from TQB_SAMP_ITEM_MODLE_JSZX ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)         };
            parameters[0].Value = C_ID;

            Mod_TQB_SAMP_ITEM_MODLE_JSZX model = new Mod_TQB_SAMP_ITEM_MODLE_JSZX();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TQB_SAMP_ITEM_MODLE_JSZX DataRowToModel(DataRow row)
        {
            Mod_TQB_SAMP_ITEM_MODLE_JSZX model = new Mod_TQB_SAMP_ITEM_MODLE_JSZX();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM TQB_SAMP_ITEM_MODLE_JSZX ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TQB_SAMP_ITEM_MODLE_JSZX T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TQB_SAMP_ITEM_MODLE_JSZX t set t.n_status=0 where t.c_samp_modle_id in(select ta.c_id from TQB_SAMP_MODLE_JSZX ta where ta.c_std_code = '" + c_std_code + "' and ta.c_stl_grd = '" + c_stl_grd + "' and nvl(ta.c_spec_min,' ')=nvl('" + c_spec_min + "',' ') and nvl(ta.c_spec_max,' ')=nvl('" + c_spec_max + "',' ') ) ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TQB_SAMP_ITEM_MODLE_JSZX t set t.n_status=0 where t.c_samp_modle_id='" + C_SAMP_MODLE_ID + "' ");
