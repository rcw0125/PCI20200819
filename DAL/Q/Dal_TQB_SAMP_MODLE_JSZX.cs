...
{
    /// <summary>
    /// 数据访问类:TQB_SAMP_MODLE_JSZX
    /// </summary>
    public partial class Dal_TQB_SAMP_MODLE_JSZX
    {
        public Dal_TQB_SAMP_MODLE_JSZX()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TQB_SAMP_MODLE_JSZX");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TQB_SAMP_MODLE_JSZX(");
            strSql.Append("C_STD_CODE,C_STL_GRD,C_SPEC_MIN,C_SPEC_MAX,N_STATUS,C_REMARK,C_EMP_ID,D_MOD_DT)");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add_Trans(Mod_TQB_SAMP_MODLE_JSZX model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TQB_SAMP_MODLE_JSZX(");
            strSql.Append("C_ID,C_STD_CODE,C_STL_GRD,C_SPEC_MIN,C_SPEC_MAX,N_STATUS,C_REMARK,C_EMP_ID,D_MOD_DT)");
            strSql.Append(" values (");
            strSql.Append(":C_ID,:C_STD_CODE,:C_STL_GRD,:C_SPEC_MIN,:C_SPEC_MAX,:N_STATUS,:C_REMARK,:C_EMP_ID,:D_MOD_DT)");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TQB_SAMP_MODLE_JSZX set ");
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TQB_SAMP_MODLE_JSZX ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)            };
            parameters[0].Value = C_ID;
        ...
        public Mod_TQB_SAMP_MODLE_JSZX GetModel(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STD_CODE,C_STL_GRD,C_SPEC_MIN,C_SPEC_MAX,N_STATUS,C_REMARK,C_EMP_ID,D_MOD_DT from TQB_SAMP_MODLE_JSZX ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)            };
            parameters[0].Value = C_ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TQB_SAMP_MODLE_JSZX DataRowToModel(DataRow row)
        {
            Mod_TQB_SAMP_MODLE_JSZX model = new Mod_TQB_SAMP_MODLE_JSZX();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STD_CODE,C_STL_GRD,C_SPEC_MIN,C_SPEC_MAX,N_STATUS,C_REMARK,C_EMP_ID,D_MOD_DT ");
            strSql.Append(" FROM TQB_SAMP_MODLE_JSZX ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TQB_SAMP_MODLE_JSZX T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT T.C_STD_CODE AS 执行标准, T.C_STL_GRD  AS 钢种, T.C_SPEC_MIN AS 规格最小值, T.C_SPEC_MAX AS 规格最大值  FROM TQB_SAMP_MODLE_JSZX T WHERE T.N_STATUS = 1   ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TQB_SAMP_MODLE_JSZX t set t.n_status=0 where t.c_std_code='" + c_std_code + "' and t.c_stl_grd='" + c_stl_grd + "' and nvl(t.c_spec_min,' ')=nvl('" + c_spec_min + "',' ') and nvl(t.c_spec_max,' ')=nvl('" + c_spec_max + "',' ') ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select max(C_ID) FROM TQB_SAMP_MODLE_JSZX ");
