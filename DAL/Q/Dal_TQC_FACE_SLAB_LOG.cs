...
namespace DAL
{
	...
	/// 数据访问类:TQC_FACE_SLAB
	/// </summary>
	public partial class Dal_TQC_FACE_SLAB_LOG
    {
		public Dal_TQC_FACE_SLAB_LOG()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TQC_FACE_SLAB_LOG");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_TQC_FACE_SLAB_LOG model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TQC_FACE_SLAB_LOG(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Mod_TQC_FACE_SLAB_LOG model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TQC_FACE_SLAB_LOG set ");
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TQC_FACE_SLAB_LOG ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TQC_FACE_SLAB_LOG GetModel(string C_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_SLAB_ID,C_STOVE,N_SEQ,N_SLAB_NO,C_STA_ID,C_STL_GRD,C_SLAB_SIZE,N_WGT,N_LEN,C_LEN_DGR,C_STD_CODE,C_MAT_CODE,C_MAT_NAME,C_JUDGE_LEV,C_REASON_NAME,C_REASON_CODE,C_REASON_DEPMT_ID,C_REASON_DEPMT_DESC,C_SUGGESTION,N_STATUS,C_REMARK,C_EMP_ID,D_MOD_DT from TQC_FACE_SLAB_LOG ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;

            Mod_TQC_FACE_SLAB_LOG model =new Mod_TQC_FACE_SLAB_LOG();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TQC_FACE_SLAB_LOG DataRowToModel(DataRow row)
		{
            Mod_TQC_FACE_SLAB_LOG model =new Mod_TQC_FACE_SLAB_LOG();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TQC_FACE_SLAB_LOG ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TQC_FACE_SLAB_LOG T ");
