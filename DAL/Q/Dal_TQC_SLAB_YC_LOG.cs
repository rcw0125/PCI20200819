...
{
    /// <summary>
    /// 数据访问类:TQC_SLAB_YC_LOG
    /// </summary>
    public partial class Dal_TQC_SLAB_YC_LOG
	{
		public Dal_TQC_SLAB_YC_LOG()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TQC_SLAB_YC_LOG");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TQC_SLAB_YC_LOG(");
			strSql.Append("C_ID,C_STOVE,C_STL_GRD,C_STD_CODE,C_MAT_CODE,C_MAT_NAME,C_SPEC,N_LEN,C_REASON,C_TYPE,N_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TQC_SLAB_YC_LOG set ");
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TQC_SLAB_YC_LOG ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TQC_SLAB_YC_LOG DataRowToModel(DataRow row)
		{
			Mod_TQC_SLAB_YC_LOG model=new Mod_TQC_SLAB_YC_LOG();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select C_ID,C_STOVE,C_STL_GRD,C_STD_CODE,C_MAT_CODE,C_MAT_NAME,C_SPEC,N_LEN,C_REASON,C_TYPE,N_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK ");
			strSql.Append(" FROM TQC_SLAB_YC_LOG ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet Get_List(string strStove,string strTime1,string strTime2)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STOVE,C_STL_GRD,C_STD_CODE,C_MAT_CODE,C_MAT_NAME,C_SPEC,N_LEN,C_REASON,C_TYPE,N_STATUS,C_EMP_ID,D_MOD_DT,C_REMARK ");
            strSql.Append(" FROM TQC_SLAB_YC_LOG where 1=1 ");
            
            if(!string.IsNullOrEmpty(strStove))
            {
                strSql.Append(" and  C_STOVE like '" + strStove + "%' ");
            }
            ...
            strSql.Append(" order by D_MOD_DT ");
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TQC_SLAB_YC_LOG T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TQC_SLAB_YC_LOG";
