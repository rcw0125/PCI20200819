...
{
	/// <summary>
	/// 数据访问类:TQR_FAULT_STA_SLAB
	/// </summary>
	public partial class Dal_TQR_FAULT_STA_SLAB
    {
		public Dal_TQR_FAULT_STA_SLAB()
		{}
		#region  BasicMethod
		...
		public bool Exists(string C_ID)
		{
			...
			strSql.Append("select count(1) from TQR_FAULT_STA_SLAB");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_TQR_FAULT_STA_SLAB model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TQR_FAULT_STA_SLAB(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Mod_TQR_FAULT_STA_SLAB model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TQR_FAULT_STA_SLAB set ");
		...
		public bool Delete(string C_ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TQR_FAULT_STA_SLAB ");
			strSql.Append(" where C_ID=:C_ID ");
			OracleParameter[] parameters = {
					new OracleParameter(":C_ID", OracleDbType.Varchar2,100)			};
			parameters[0].Value = C_ID;
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TQR_FAULT_STA_SLAB GetModel(string C_ID)
		{
			...
			Mod_TQR_FAULT_STA_SLAB model=new Mod_TQR_FAULT_STA_SLAB();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_TQR_FAULT_STA_SLAB DataRowToModel(DataRow row)
		{
			Mod_TQR_FAULT_STA_SLAB model=new Mod_TQR_FAULT_STA_SLAB();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM TQR_FAULT_STA_SLAB ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from TQR_FAULT_STA_SLAB T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "TQR_FAULT_STA_SLAB";
