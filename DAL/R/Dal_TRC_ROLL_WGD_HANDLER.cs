...
namespace DAL
{
    public partial class Dal_TRC_ROLL_WGD_HANDLER
    {
        public Dal_TRC_ROLL_WGD_HANDLER()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TRC_ROLL_WGD_HANDLER");
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TRC_ROLL_WGD_HANDLER ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)            };
            parameters[0].Value = C_ID;
        ...
        public DataSet GetList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_STA_ID,C_WGD_ID,C_STOVE,C_BATCH_NO,C_PLAN_ID,D_MOD_DT,N_STATUS,C_STD_CODE,C_STL_GRD,C_SPEC,C_PACK,C_FREE_TERM,C_FREE_TERM2,C_MRSX,C_MAT_CODE,C_MAT_DESC,C_PCLX,C_NEWMRSX,C_NEWPCLX,C_NEW_STD_CODE,C_NEW_STL_GRD,C_NEW_SPEC,C_NEW_PACK,C_NEW_FREE_TERM,C_NEW_FREE_TERM2,C_NEW_MAT_CODE,C_NEW_MAT_DESC,C_SX,C_NEW_SX ");
            strSql.Append(" FROM TRC_ROLL_WGD_HANDLER ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TRC_ROLL_WGD_HANDLER T ");
        ...
        {
            string sql = @"SELECT TRWH.N_STATUS FROM TRC_ROLL_WGD_HANDLER TRWH
                                     WHERE TRWH.C_WGD_ID='" + id + "'     order by trwh.d_mod_dt desc   ";
