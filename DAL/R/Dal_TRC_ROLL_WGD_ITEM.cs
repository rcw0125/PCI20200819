...
namespace DAL
{
    public partial class Dal_TRC_ROLL_WGD_ITEM
    {
        public Dal_TRC_ROLL_WGD_ITEM()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TRC_ROLL_WGD_ITEM");
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TRC_ROLL_WGD_ITEM ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TRC_ROLL_WGD_ITEM GetModel(string C_ID)
        {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_MAIN_ID,C_ROLL_WGD_ID,C_BATCH_NO,N_STATUS,C_STD_CODE,C_STL_GRD,C_SPEC,C_MAT_CODE,C_MAT_DESC,C_SALE_AREA,C_ZYX1,C_ZYX2,C_BZYQ,C_MRSX ");
            strSql.Append(" FROM TRC_ROLL_WGD_ITEM ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TRC_ROLL_WGD_ITEM T ");
