...
{
    /// <summary>
    /// 数据访问类:TRP_PLAN_ITEM_LOG
    /// </summary>
    public partial class Dal_TRP_PLAN_ITEM_LOG
    {
        public Dal_TRP_PLAN_ITEM_LOG()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TRP_PLAN_ITEM_LOG");
        ...
        public bool Add(Mod_TRP_PLAN_ITEM_LOG model)
        {
            ...
            OracleParameter[] parameters = {
                    ...
                    new OracleParameter(":C_PC_RQ", OracleDbType.Varchar2,100)};
            ...
            parameters[99].Value = model.C_PC_RQ;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TRP_PLAN_ITEM_LOG set ");
            ...
            parameters[98].Value = model.C_PC_RQ;
            parameters[99].Value = model.C_ID;
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TRP_PLAN_ITEM_LOG ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)         };
            parameters[0].Value = C_ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TRP_PLAN_ITEM_LOG DataRowToModel(DataRow row)
        {
            Mod_TRP_PLAN_ITEM_LOG model = new Mod_TRP_PLAN_ITEM_LOG();
            if (row != null)
            {
                ...
                if (row["C_PC_RQ"] != null)
                {
                    model.C_PC_RQ = row["C_PC_RQ"].ToString();
                }
            }
            return model;
        }
        ...
        public DataSet GetList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_PLAN_ROLL_ID,N_STATUS,C_INITIALIZE_ITEM_ID,C_ORDER_NO,N_WGT,C_MAT_CODE,C_MAT_NAME,C_TECH_PROT,C_SPEC,C_STL_GRD,C_STD_CODE,N_USER_LEV,N_STL_GRD_LEV,N_ORDER_LEV,C_QUALIRY_LEV,D_NEED_DT,D_DELIVERY_DT,D_DT,C_LINE_DESC,C_LINE_CODE,D_P_START_TIME,D_P_END_TIME,N_PROD_TIME,N_SORT,N_ROLL_PROD_WGT,C_ROLL_PROD_EMP_ID,C_STL_ROL_DT,N_PROD_WGT,N_WARE_WGT,N_WARE_OUT_WGT,N_FLAG,N_ISSUE_WGT,C_CUST_NO,C_CUST_NAME,C_SALE_CHANNEL,C_PACK,C_DESIGN_NO,N_GROUP_WGT,C_STA_ID,D_START_TIME,D_END_TIME,C_EMP_ID,D_MOD_DT,N_ROLL_WGT,N_MACH_WGT,C_CAST_NO,C_INITIALIZE_ID,C_FREE_TERM,C_FREE_TERM2,C_AREA,C_PCLX,C_SFHL,D_HL_START_TIME,D_HL_END_TIME,C_SFHL_D,D_DHL_START_TIME,D_DHL_END_TIME,C_SFKP,D_KP_START_TIME,D_KP_END_TIME,C_SFXM,D_XM_START_TIME,D_XM_END_TIME,N_UPLOADSTATUS,C_MATRL_CODE_SLAB,C_MATRL_NAME_SLAB,C_SLAB_SIZE,N_SLAB_LENGTH,N_SLAB_PW,D_CAN_ROLL_TIME,C_ROUTE,N_DIAMETER,C_XM_YQ,N_JRL_WD,N_JRL_SJ,C_STL_GRD_SLAB,C_STD_CODE_SLAB,C_REMARK,N_HG_WGT,N_DP_WGT,N_GP_WGT,N_XY_WGT,N_TW_WGT,N_BHG_WGT,N_HG_WGT_IN,N_GP_WGT_IN,N_XY_WGT_IN,N_TW_WGT_IN,N_BHG_WGT_IN,N_HG_WGT_OUT,N_GP_WGT_OUT,N_XY_WGT_OUT,N_TW_WGT_OUT,N_BHG_WGT_OUT,D_SALE_TIME_MIN,D_SALE_TIME_MAX,D_PRODUCE_DATE_MIN,D_PRODUCE_DATE_MAX,C_PC_RQ ");
            strSql.Append(" FROM TRP_PLAN_ITEM_LOG ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TRP_PLAN_ITEM_LOG T ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select T.N_ROLL_PROD_WGT,t.D_P_START_TIME,t.D_P_END_TIME,t.C_SPEC from trp_plan_item_log t where t.c_plan_roll_id='" + c_plan_roll_id + "' and t.c_pc_rq='" + strPcName + "' ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT distinct B.C_LINE_CODE FROM TRP_PLAN_ITEM_Log A INNER JOIN TRP_PLAN_ROLL_Log B ON A.C_PLAN_ROLL_ID = B.C_ID WHERE A.N_STATUS = 0 and a.c_pc_rq='" + strPcName + "' and b.c_pc_rq='" + strPcName + "'  ");
        ...
        public DataSet Get_Plan_Item_List(string C_STA_ID, string strPcName)
        {
            ...
            strSql.Append(" FROM TRP_PLAN_ITEM_Log where 1=1 and c_pc_rq='" + strPcName + "' ");
