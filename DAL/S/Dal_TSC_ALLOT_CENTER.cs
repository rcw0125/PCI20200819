...
namespace DAL
{
    public partial class Dal_TSC_ALLOT_CENTER
    {
        public Dal_TSC_ALLOT_CENTER()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string C_ID)
        {
            ...
            strSql.Append("select count(1) from TSC_ALLOT_CENTER");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TSC_ALLOT_CENTER(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TSC_ALLOT_CENTER set ");
        ...
        public bool Delete(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from TSC_ALLOT_CENTER ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)            };
            parameters[0].Value = C_ID;
        ...
        public Mod_TSC_ALLOT_CENTER GetModel(string C_ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_SLAB_MAIN_ID,N_TYPE,D_MOD_DT,C_EMP_ID,C_STA_ID,C_SLABWH_CODE,C_SLABWH_AREA_CODE,C_SLABWH_LOC_CODE,C_SLABWH_TIER_CODE from TSC_ALLOT_CENTER ");
            strSql.Append(" where C_ID=:C_ID ");
            OracleParameter[] parameters = {
                    new OracleParameter(":C_ID", OracleDbType.Varchar2,100)            };
            parameters[0].Value = C_ID;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mod_TSC_ALLOT_CENTER DataRowToModel(DataRow row)
        {
            Mod_TSC_ALLOT_CENTER model = new Mod_TSC_ALLOT_CENTER();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM TSC_ALLOT_CENTER ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TSC_ALLOT_CENTER T ");
