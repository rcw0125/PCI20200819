...
namespace DAL
{
    public class Transaction_MES
    {

        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.	
        private static string connectionString = "Data Source=192.168.36.153/ORCL;User Id=xgmes;Password=xgmes;enlist=dynamic";
