...
{
    /// <summary>
    /// 数据访问类:SeZJB_FYD_finished
    /// </summary>
    public partial class Dal_SeZJB_FYD_finished
	{
		public Dal_SeZJB_FYD_finished()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Mod_SeZJB_FYD_finished model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SeZJB_FYD_finished(");
			strSql.Append("fydh,finished,ZJBstatus,ts,by1,by2,by3,by4,by5)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Mod_SeZJB_FYD_finished model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SeZJB_FYD_finished ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_SeZJB_FYD_finished GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 fydh,finished,ZJBstatus,ts,by1,by2,by3,by4,by5 from SeZJB_FYD_finished ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Mod_SeZJB_FYD_finished model=new Mod_SeZJB_FYD_finished();
		...
		/// 得到一个对象实体
		/// </summary>
		public Mod_SeZJB_FYD_finished DataRowToModel(DataRow row)
		{
			Mod_SeZJB_FYD_finished model=new Mod_SeZJB_FYD_finished();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select fydh,finished,ZJBstatus,ts,by1,by2,by3,by4,by5 ");
			strSql.Append(" FROM SeZJB_FYD_finished ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM SeZJB_FYD_finished ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SeZJB_FYD_finished T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SeZJB_FYD_finished";
