...
namespace MODEL
{
	...
	/// </summary>
	[Serializable]
	public partial class Mod_TPB_RINSE_GRD
	{
		public Mod_TPB_RINSE_GRD()
		{}
		#region Model
		private string _c_id= "sys_guid";
		private string _c_rinse_grd;
		...
		private string _c_rinse_std_code;
		...
		/// 涮槽钢种
		/// </summary>
		public string C_RINSE_GRD
		{
			set{ _c_rinse_grd=value;}
			get{return _c_rinse_grd;}
		}
		/// <summary>
		/// 优先级
		/// </summary>
		...
		/// 执行标准
		/// </summary>
		public string C_RINSE_STD_CODE
		{
			set{ _c_rinse_std_code=value;}
			get{return _c_rinse_std_code;}
		}
		/// <summary>
		/// 钢种生成条件主表外键
		/// </summary>
