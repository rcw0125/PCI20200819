...
namespace MODEL
{
	...
	/// </summary>
	[Serializable]
	public partial class Mod_TPB_SLABWH_TIER
    {
		public Mod_TPB_SLABWH_TIER()
		{}
		#region Model
		private string _c_id= "sys_guid";
		private string _c_slabwh_loc_id;
		private string _c_slabwh_tier_code;
		private string _c_slabwh_tier_name;
		private decimal? _n_slabwh_tier_num;
		...
		/// 钢坯库位主键
		/// </summary>
		public string C_SLABWH_LOC_ID
		{
			set{ _c_slabwh_loc_id=value;}
			get{return _c_slabwh_loc_id;}
		}
		/// <summary>
		/// 钢坯库层编码
		/// </summary>
		...
		/// 钢坯库层描述
		/// </summary>
		public string C_SLABWH_TIER_NAME
		{
			set{ _c_slabwh_tier_name=value;}
			get{return _c_slabwh_tier_name;}
		}
		/// <summary>
		/// 当层对方最大支数
		/// </summary>
		public decimal? N_SLABWH_TIER_NUM
		{
			set{ _n_slabwh_tier_num=value;}
			get{return _n_slabwh_tier_num;}
		}
		/// <summary>
		/// 启用日期
		/// </summary>
