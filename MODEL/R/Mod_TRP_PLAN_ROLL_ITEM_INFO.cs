...
namespace MODEL
{
    public class Mod_TRP_PLAN_ROLL_ITEM_INFO
    {
        public Mod_TRP_PLAN_ROLL_ITEM_INFO()
        { }
        #region Model
...
;
        ...
        private decimal? _n_hg_wgt = 0
;
        private decimal? _n_dp_wgt = 0
;
        private decimal? _n_gp_wgt = 0
;
        private decimal? _n_xy_wgt = 0
;
        private decimal? _n_tw_wgt = 0
;
        private decimal? _n_bhg_wgt = 0
;
        private decimal? _n_hg_wgt_in = 0
;
        private decimal? _n_gp_wgt_in = 0
;
        private decimal? _n_xy_wgt_in = 0
;
        private decimal? _n_tw_wgt_in = 0
;
        private decimal? _n_bhg_wgt_in = 0
;
        private decimal? _n_hg_wgt_out = 0
;
        private decimal? _n_gp_wgt_out = 0
;
        private decimal? _n_xy_wgt_out = 0
;
        private decimal? _n_tw_wgt_out = 0
;
        private decimal? _n_bhg_wgt_out = 0
;
        ...
        /// 
        /// </summary>
        public string C_ITEM_ID
        {
            set { _c_item_id = value; }
            get { return _c_item_id; }
        }
        #endregion Model
    }
}
