...
namespace MODEL
{
    ...
    /// </summary>
    [Serializable]
	public partial class Mod_TSP_PLAN_SMS
	{
		public Mod_TSP_PLAN_SMS()
		{}

        public string C_CREAT_PLAN
        {
            get
            {
                if (N_CREAT_PLAN == 1)
                ...
                else if (N_CREAT_PLAN == 2)
                {
                    return "已下调度";

                }
                else if (N_CREAT_PLAN == 3)
                {
                    return "已下MES";

                }
                else if (N_CREAT_PLAN == 0)
                {
                    return "已删除";
                }
                else
		...
		private decimal _n_creat_plan=0;
		...
		private string _c_dfp_rz="N";
		private string _c_rzp_rz="N";
        ...
        private decimal? _n_kp_sort;
        private decimal? _n_xm_sort;
        private string _c_kp_id;
        private string _c_xm_id;

        private DateTime? _d_kp_can_start_time;
        private DateTime? _d_xm_can_start_time;
        private decimal? _n_kp_jrl_hour;
        private string _c_dq_order;
        private decimal? _n_new_status;
        private decimal? _n_kp_status;
        private decimal? _n_xm_status;
        private decimal? _n_dhl_status;
        private decimal? _n_hl_status;
        private decimal? _n_order_wgt;
        private string _c_bxggz;
        private decimal? _n_sfkppc;
        /// <summary>
        /// 主键
        /// </summary>
        public string C_ID
        ...
        /// <summary>
        /// 是否生成开坯计划；0未生成开坯计划；1开坯计划已下发,2开坯生产中,3完成
        /// </summary>
		...
		/// 开坯排序
		/// </summary>
		public decimal? N_KP_SORT
        {
            set { _n_kp_sort = value; }
            get { return _n_kp_sort; }
        }
        /// <summary>
        /// 修磨排序
        /// </summary>
        public decimal? N_XM_SORT
        {
            set { _n_xm_sort = value; }
            get { return _n_xm_sort; }
        }
        /// <summary>
        /// 开坯工位
        /// </summary>
		...
		/// 钢坯可以开坯的时间
		/// </summary>
		public DateTime? D_KP_CAN_START_TIME
        {
            set { _d_kp_can_start_time = value; }
            get { return _d_kp_can_start_time; }
        }
        /// <summary>
        /// 钢坯可修磨的时间（修磨时间建立在开坯计划确定的基础上）
        /// </summary>
        public DateTime? D_XM_CAN_START_TIME
        {
            set { _d_xm_can_start_time = value; }
            get { return _d_xm_can_start_time; }
        }
        /// <summary>
        /// 开坯加热炉加热时间
        /// </summary>
        public decimal? N_KP_JRL_HOUR
        {
            set { _n_kp_jrl_hour = value; }
            get { return _n_kp_jrl_hour; }
        }
        /// <summary>
        /// 当期排产是否有订单
        /// </summary>
        public string C_DQ_ORDER
        {
            set { _c_dq_order = value; }
            get { return _c_dq_order; }
        }
        /// <summary>
        /// 本炉计划实时状态1库存钢坯，0可热轧坯
        /// </summary>
        public decimal? N_NEW_STATUS
        {
            set { _n_new_status = value; }
            get { return _n_new_status; }
        }
        /// <summary>
        /// 是否已开坯1未开坯，0已开坯
        /// </summary>
        public decimal? N_KP_STATUS
        {
            set { _n_kp_status = value; }
            get { return _n_kp_status; }
        }
        /// <summary>
        /// 是否已修磨1未修磨，0已修磨
        /// </summary>
        public decimal? N_XM_STATUS
        {
            set { _n_xm_status = value; }
            get { return _n_xm_status; }
        }
        /// <summary>
        /// 大方坯是否已缓冷1未缓冷，0已缓冷
        /// </summary>
        public decimal? N_DHL_STATUS
        {
            set { _n_dhl_status = value; }
            get { return _n_dhl_status; }
        }
        /// <summary>
        /// 连铸坯或热轧坯是否已已缓冷1未缓冷，0已缓冷
        /// </summary>
        public decimal? N_HL_STATUS
        {
            set { _n_hl_status = value; }
            get { return _n_hl_status; }
        }
        /// <summary>
        /// 本次排产订单重量
        /// </summary>
        public decimal? N_ORDER_WGT
        {
            set { _n_order_wgt = value; }
            get { return _n_order_wgt; }
        }

        /// <summary>
        /// 计算时间Start
        /// </summary>
        public DateTime? CalCulateTimeStart
        {
            set;
            get;
        }
        ...
        /// 计算时间End
        /// </summary>
        public DateTime? CalCulateTimeEnd
        {
            set;
            get;
        }
        ...
        /// 是否开坯排产
        /// </summary>
        public decimal? N_SFKPPC
        {
            set { _n_sfkppc = value; }
            get { return _n_sfkppc; }
        }
        #endregion Model
