...
namespace MODEL
{
	...
	/// </summary>
	[Serializable]
	public partial class Mod_TSP_PLAN_SMS_LOG
	{
		public Mod_TSP_PLAN_SMS_LOG()
		{}
		#region Model
		...
		private decimal _n_creat_plan=1M;
		private decimal _n_creat_zg_plan=0M;
		private decimal _n_produce_time=0M;
		...
		/// <summary>
		/// 是否生成炉次计划；0未生成；1已计算时间；2已下发调度；3已下发MES,4完成
		/// </summary>
