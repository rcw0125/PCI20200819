...
{
    /// <summary>
    /// 数据访问类:TS_USER_FUN_PCI
    /// </summary>
    public partial class DalTS_USER_FUN_PCI
    {
        public DalTS_USER_FUN_PCI()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(ModTS_USER_FUN_PCI model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into TS_USER_FUN_PCI(");
            strSql.Append("C_ID,C_MODULE_ID,C_USER_ID,C_FUNCTION_TYPE,D_MOD_DT)");
            ...
            parameters[2].Value = model.C_USER_ID;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(ModTS_USER_FUN_PCI model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update TS_USER_FUN_PCI set ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public ModTS_USER_FUN_PCI GetModel()
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select C_ID,C_MODULE_ID,C_USER_ID,C_FUNCTION_TYPE,D_MOD_DT from TS_USER_FUN_PCI ");
            strSql.Append(" where ");
            OracleParameter[] parameters = {
            };

            ModTS_USER_FUN_PCI model = new ModTS_USER_FUN_PCI();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ModTS_USER_FUN_PCI DataRowToModel(DataRow row)
        {
            ModTS_USER_FUN_PCI model = new ModTS_USER_FUN_PCI();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM TS_USER_FUN_PCI ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TS_USER_FUN_PCI T ");
        ...
        /// <returns></returns>
        public bool SaveFun(List<string> lstCheckedID, DataTable dt, string strUserID)
        {
            ...
            {
                SQLStringList.Add(" insert into TS_USER_FUN_PCI(C_MODULE_ID, C_USER_ID, C_FUNCTION_TYPE)values('" + id + "','" + strUserID + "','2') ");
            }


            for (int i = 0; i < dt.Rows.Count; i++)
            {
                SQLStringList.Add(" insert into TS_USER_FUN_PCI(C_MODULE_ID, C_USER_ID, C_FUNCTION_TYPE)values('" + dt.Rows[i]["C_MODULEID"].ToString() + "','" + strUserID + "','1') ");
            }
