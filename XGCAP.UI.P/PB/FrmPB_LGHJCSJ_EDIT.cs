...
{
    public partial class FrmPB_LGHJCSJ_EDIT : Form
    {
        public FrmPB_LGHJCSJ_EDIT()
        {
            InitializeComponent();
        }
        ...
        public string c_id;
        private void FrmPB_LGHJCSJ_EDIT_Load(object sender, EventArgs e)
        {
            ...
            txt_JSCN.Text = (mod.N_TIME).ToString();
        }
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                mod.N_TIME = Convert.ToDecimal(txt_JSCN.Text);
                ...
                Common.UserLog.AddLog(strMenuName, this.Name, this.Text, "修改炼钢换浇次时间");//添加操作日志
