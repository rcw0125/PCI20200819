...
{
    public partial class FrmPB_ZGKSCGZ : Form
    {
        string stacode = "";
        public FrmPB_ZGKSCGZ()
        {
            InitializeComponent();
        ...
        Bll_TPB_Y_GRD bll_TPB_N_GRD = new Bll_TPB_Y_GRD();
        Bll_TQB_STD_MAIN bll_TQB_STD_MAIN = new Bll_TQB_STD_MAIN();
        private void FrmPB_ZGKSCGZ_Load(object sender, EventArgs e)
        {

            UserButtonRight.GetBtnFun(this, RV.UI.UserInfo.menuID);
            strMenuName = RV.UI.UserInfo.menuName;
            sub.ImageComboBoxEditBindGWByGXstr("'"+stacode+"'", cbo_GW1);
            cbo_GW1.SelectedIndex = 0;
            sub.ImageComboBoxEditBindGWByGXstr("'"+stacode+"'", imgcbo_cx1);
            imgcbo_cx1.Properties.Items.Add("全部", stacode, 0);
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Mod_TPB_Y_GRD mod_TPB_N_GRD = new Mod_TPB_Y_GRD();
                    ...
                    ht.Add("N_STATUS", 1);
                    if (Common.CheckRepeat.CheckTable("TPB_Y_GRD", ht) > 0)
                    {
