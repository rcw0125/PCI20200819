...
{
    public partial class FrmPO_APS_LGPC_NEW_BXG : Form
    {
        public FrmPO_APS_LGPC_NEW_BXG()
        {
            InitializeComponent();
        }
        ...
        private void FrmPO_APS_LGPC_Load(object sender, EventArgs e)
        {
            ...
            CommonSub.BindIcboBXG("", "CC", icbo_lz3);
        ...
        public int[] Down_Jc_Plan(string c_id, int max_lc_sort, int max_jc_sort)
        {
            ...
            #region 插入操作日志
            Cls_APS_PC.WritePlanLog( "浇次计划确认", "炼钢生产顺序", mod_jc_ls.C_CCM_ID, c_id);//保存连铸机主键、浇次计划主键
            #endregion
            //获取当前炉次计划最大序号
