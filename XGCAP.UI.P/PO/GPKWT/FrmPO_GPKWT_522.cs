...
{
    public partial class FrmPO_GPKWT_522 : Form
    {
        public FrmPO_GPKWT_522()
        {
            InitializeComponent();
        }
        ...
        private void lab_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_con = bll_TSC_SLAB_MAIN.GetList_KW("522",lab_id.AccessibleDescription ).Tables[0];
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    foreach (var item in this.pnlMain.Controls)
                    {
                        if (item is DevExpress.XtraEditors.LabelControl)
                        {
                            ...
                            {
                                DataTable dt_con = bll_TSC_SLAB_MAIN.GetList_KW("522" ,lbla.AccessibleDescription).Tables[0];
