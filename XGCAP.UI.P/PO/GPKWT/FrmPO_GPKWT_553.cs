...
{
    public partial class FrmPO_GPKWT_553 : Form
    {
        public FrmPO_GPKWT_553()
        {
            InitializeComponent();
        }
        ...
        private void lab_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_con = bll_TSC_SLAB_MAIN.GetList_KW("553",lab_id.AccessibleDescription ).Tables[0];
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    foreach (var item in this.pnlMain.Controls)
                    {
                        if (item is DevExpress.XtraEditors.LabelControl)
                        {
                            ...
                            {
                                DataTable dt_con = bll_TSC_SLAB_MAIN.GetList_KW("553" ,lbla.AccessibleDescription).Tables[0];
