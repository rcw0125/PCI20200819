...
{
    public partial class FrmPO_XCKWT_12_16 : Form
    {
        public FrmPO_XCKWT_12_16()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dt = bll_TRC_Roll_Product.GetList_RK_KW(BatchNo, kw, "61216","612").Tables[0];
        ...
        private void lab_Click(object sender, EventArgs e)
        {
            ...
            string[] str = kw.Split(',');
            DataTable dt = bll_TRC_Roll_Product.GetList_LXC("61216", str[0], str[1]).Tables[0];
            gc_SJXX.DataSource = dt;
            gv_SJXX.BestFitColumns();
            SetGridViewRowNum.SetRowNum(gv_SJXX);
        }
        ...
        private void FrmPO_XCKWT_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt_01_25 = bll_TRC_Roll_Product.GetList_LXC("61216", "1", "25").Tables[0];
            DataTable dt_26_50 = bll_TRC_Roll_Product.GetList_LXC("61216", "26", "50").Tables[0];
            DataTable dt_51_75 = bll_TRC_Roll_Product.GetList_LXC("61216", "51", "75").Tables[0];
            DataTable dt_76_99 = bll_TRC_Roll_Product.GetList_LXC("61216", "76", "99").Tables[0];
