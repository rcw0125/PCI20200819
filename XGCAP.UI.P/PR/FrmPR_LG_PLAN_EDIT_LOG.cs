...
{
    public partial class FrmPR_LG_PLAN_EDIT_LOG : Form
    {
        private Bll_TB_LG_PLAN_EDIT_LOG bllLog = new Bll_TB_LG_PLAN_EDIT_LOG();

        public FrmPR_LG_PLAN_EDIT_LOG()
        {
            InitializeComponent();
        }

        private void FrmPR_LG_PLAN_EDIT_LOG_Load(object sender, EventArgs e)
        {
