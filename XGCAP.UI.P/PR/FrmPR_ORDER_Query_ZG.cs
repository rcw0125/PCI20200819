...
{
    public partial class FrmPR_ORDER_Query_ZG : Form
    {
        public FrmPR_ORDER_Query_ZG()
        {
            InitializeComponent();
        }
        ...
        private void btn_query_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = bll_order.GetPlanZX_Query_ZG(dte_Begin.DateTime, dte_End.DateTime, txt_gz1.Text.Trim(), txt_zxbz1.Text.Trim(), txt_gg_min.Text.Trim(), "", txt_order_no.Text.Trim(), C_SFPJ, sfwc, n_sfqr, c_line_no, c_type);
