...
{
    public partial class Frm_PR_LG_GTT2 : Form
    {
        public Frm_PR_LG_GTT2()
        {
            InitializeComponent();
        }
        ...
        private void Frm_PR_LG_GTT2_Load(object sender, EventArgs e)
        {
            ...
            //获取炼钢计划
            var ds = bll_tpc_plan_sms.GetTaskPlans();
            ...
            if (planDt.Rows.Count > 0)
            {
                ...
                foreach (DataRow planRow in planDt.Rows)
                {
                    ...
                    foreach (var detailsRow in detailRows)
                    {
                        ...
                        taskDetail.Subject = detailsRow["C_REMARK"].ToString();
                        taskDetail.Description = "0";
                        taskDetail.Label = "0";
                    ...
                    {
                        TaskDetails taskDetail = new TaskDetails();
                        taskDetail.ID = Guid.NewGuid().ToString();
                        ...
                        taskDetail.Subject = factRow["C_REMARK"].ToString();
