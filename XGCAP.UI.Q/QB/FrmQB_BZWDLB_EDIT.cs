...
{
    public partial class FrmQB_BZWDLB_EDIT : Form
    {


        public FrmQB_BZWDLB_EDIT()
        {
        ...
        public string c_id;
        private void FrmQB_BZWDLB_EDIT_Load(object sender, EventArgs e)
        {
            strMenuName = RV.UI.UserInfo.menuName;

            Mod_TQB_STD_FILE_TYPE mod = bll.GetModel(c_id);
            txt_Type.Text = mod.C_FILE_TYPE_NAME;
        ...
        { 
            ...
            try
            {
                ...
                ht.Add("N_STATUS", 1);
                ht.Add("C_FILE_TYPE_NAME", mod.C_FILE_TYPE_NAME);
                ...
                Common.UserLog.AddLog(strMenuName, this.Name, this.Text, "修改标准文档类别");//添加操作日志  
            }
            catch (Exception ex)
            {
