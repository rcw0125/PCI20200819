...
{
    public partial class FrmQB_GZPMWH_EDIT : Form
    {
         
        public FrmQB_GZPMWH_EDIT()
        { 
            InitializeComponent();
        }
        ...
        { 
            ...
            Mod_TQB_STL_GRD_NAME mod = bll.GetModel(c_id);
        ...
        private void btn_Seave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                { 
                    ...
                    Common.UserLog.AddLog(strMenuName, this.Name, this.Text, "修改钢种品名");//添加操作日志 
                } 
