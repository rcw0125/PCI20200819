...
{
    public partial class FrmQB_GZPZWH : Form
    {
        public FrmQB_GZPZWH()
        {
            InitializeComponent();
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Mod_TQB_STL_GRD_TYPE mod = new Mod_TQB_STL_GRD_TYPE();
                ...
                if (bll.Add(mod))
                {
                    ...
                    NewMethod();
                    Common.UserLog.AddLog(strMenuName, this.Name, this.Text, "添加钢种品种");//添加操作日志
                }
            }
            catch (Exception ex)
            {
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                FrmQB_GZPZWH_EDIT frm = new FrmQB_GZPZWH_EDIT();
