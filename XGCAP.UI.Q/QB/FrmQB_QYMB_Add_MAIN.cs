...
{
    public partial class FrmQB_QYMB_Add_MAIN : Form
    {
        private Bll_TQB_SAMP_MODLE bllTqbSampModle = new Bll_TQB_SAMP_MODLE();

        public FrmQB_QYMB_Add_MAIN()
        {
            InitializeComponent();
        }

        private void FrmQB_QYMB_Add_MAIN_Load(object sender, EventArgs e)
        {
