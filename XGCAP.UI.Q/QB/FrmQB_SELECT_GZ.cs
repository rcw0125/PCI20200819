...
namespace XGCAP.UI.Q.QB
{
    ...
    /// 2018-04-27 zmc
    /// </summary>
    public partial class FrmQB_SELECT_GZ : Form
    {
        string strMenuName = "";
        public FrmQB_SELECT_GZ(string sys_id)
        {
            InitializeComponent();
            strMenuName = sys_id;
        }
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = bll.GetList_Type(txt_GRD.Text.Trim(), strMenuName).Tables[0];
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmQB_HLYQ_GZ_Load(object sender, EventArgs e)
        { 
