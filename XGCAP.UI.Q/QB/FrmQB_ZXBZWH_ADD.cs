...
namespace XGCAP.UI.Q.QB
{
    ...
    /// 2018-04-28 zmc
    /// </summary>
    public partial class FrmQB_ZXBZWH_ADD : Form
    {
        string strPhyCode = "";
        public FrmQB_ZXBZWH_ADD(string sys_id)
        {
            InitializeComponent();
            strPhyCode = sys_id;
        ...
        private void FrmQB_ZXBZWH_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_Update_CF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 0; i < gv_StdCF.DataRowCount; i++)
                {
                    ...
                    {
                        mod.C_TARGET_INTERVAL = dr["C_TARGET_INTERVAL"].ToString();
                        mod.C_TARGET_MIN = null;
                        mod.C_TARGET_MAX = null;
                    }
                    #endregion
