...
namespace XGCAP.UI.Q.QB
{
    ...
    /// 2018-04-28 zmc
    /// </summary>
    public partial class FrmQB_ZXBZWH_Edit : Form
    {
        string strPhyCode = "";
        public FrmQB_ZXBZWH_Edit(string sys_id)
        {
            InitializeComponent();
            strPhyCode = sys_id;
        }
        ...
        string str_id = "";
        private void FrmQB_ZXBZWH_Edit_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            Mod_TQB_STD_MAIN mod = bll_stdmain.GetModel(txt_ID.Text);
            ...
            imgcbo_grdtype.EditValue = mod.C_PROD_NAME;
            imgcbo_prodkind.EditValue = mod.C_PROD_KIND;
        ...
        private void NewMethod_XN()
        {
            ...
            this.gc_StdXN.DataSource = dt_XN;//冻结有焦点的列
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Mod_TQB_STD_MAIN mod_XG = bll_stdmain.GetModel(this.txt_ID.Text);
                mod_XG.N_STATUS = 0;
                mod_XG.C_EMP_ID = RV.UI.UserInfo.UserID;
                bll_stdmain.Update(mod_XG);
