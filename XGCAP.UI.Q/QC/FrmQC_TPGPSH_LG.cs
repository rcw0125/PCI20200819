...
{
    public partial class FrmQC_TPGPSH_LG : Form
    {
        public FrmQC_TPGPSH_LG()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                for (int i = 0; i < rownumber.Length; i++)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        mod.C_CHECK_LG = "Y";
                        mod.C_CZYJ_LG = txt_CZYJ.Text.Trim();
                        mod.C_LG_EMP_ID = RV.UI.UserInfo.UserName;
                        mod.D_CHECK_LG_DATE = RV.UI.ServerTime.timeNow();
