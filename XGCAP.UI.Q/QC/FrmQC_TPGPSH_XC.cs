...
{
    public partial class FrmQC_TPGPSH_XC : Form
    {
        public FrmQC_TPGPSH_XC()
        {
            InitializeComponent();
        }
        ...
        private void btn_Query1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = bllTPSlab.GetList_TP_LG(dte_Begin.DateTime, dte_End.DateTime, txt_Stove1.Text.Trim()).Tables[0];
            ...
            try
            {
                ...
                for (int i = 0; i < rownumber.Length; i++)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        mod.C_CHECK_XC = "Y";
                        mod.C_CZYJ_XC = txt_CZYJ.Text.Trim();
                        mod.C_XC_EMP_ID = RV.UI.UserInfo.UserName;
                        mod.D_CHECK_XC_DATE = RV.UI.ServerTime.timeNow();
