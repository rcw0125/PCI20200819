...
namespace XGCAP.UI.Q.QC
{
    ...
    /// 2018-05-24 zmc
    /// </summary>
    public partial class FrmQC_XCGP : Form
    {
        public FrmQC_XCGP()
        {
            InitializeComponent();
        ...
        private void btn_Query_Click(object sender, EventArgs e)
        {
            ...
            {
                WaitingFrom.ShowWait("");
                DataTable dt = bll_commute.GetList_Query(dte_Begin.DateTime, dte_End.DateTime, txt_BatchNo1.Text.Trim() ).Tables[0];
        ...
        private void gv_SJXX_SelectionChanged(object sender, DevExpress.Data.SelectionChangedEventArgs e)
        {
            try
            {
                ...
                if (rownumber.Length == 0)
                {
                    ...
                    txt_mat_name.Text = "";
                    imgcbo_BPLX.Text = "";
                    imgcbo_ZYX3.EditValue = null;
                    imgcbo_PDDJ.EditValue = null;
                    txt_ZYX1.Text = "";
                     txt_ZYX2.Text = "";
                }
                else
