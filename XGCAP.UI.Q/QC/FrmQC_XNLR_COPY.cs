...
{
    public partial class FrmQC_XNLR_COPY : Form
    {
        ...
        public FrmQC_XNLR_COPY()
        {
            InitializeComponent();
        }

        private void FrmQC_XNLR_COPY_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BindResult()
        {
            ...
            DataTable dt = bllTqcPhysicsResult.Get_List(strPhyCode, txt_Batch_Result.Text.Trim(), dt_Start_Result.Text.Trim(), dt_End_Result.Text.Trim(), "1").Tables["ds"];
