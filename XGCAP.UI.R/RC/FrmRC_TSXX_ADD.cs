...
{
    public partial class FrmRC_TSXX_ADD : Form
    {
        public FrmRC_TSXX_ADD()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void FrmRC_TSXX_ADD_Load(object sender, EventArgs e)
        {
            strLineCode = RV.UI.QueryString.parameter;
            ...
            DataSet dt = bllSpecific.GetList(" nvl(C_CONTENT,' ')='待包装' ");
        ...
        private void BindInfo()
        {
            try
            {
                ...
                DataTable dt = bll_roll_product.GetList_TSXX(txt_BatchNo.Text.Trim(), dt_Start.Text.Trim(), dt_End.Text.Trim(), "全部", strLineCode).Tables[0];
