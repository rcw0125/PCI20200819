...
{
    public partial class FrmFR_ZKDTB : Form
    {
        public FrmFR_ZKDTB()
        {
            InitializeComponent();
        ...
        private void FrmFR_ZKDTB_Load(object sender, EventArgs e)
        {
            Query();
            YWQuery();
        }
        ...
        private void Query()
        {
            ...
            {
                DataTable dt = null;
                dt = bll_Interface_FR.GetTMZKZJB(txt_ZKD.Text.Trim()).Tables[0];
        ...
        private void btn_TB_Click(object sender, EventArgs e)
        {
            ...
            string message = bll_Interface_FR.TBZKD1(Application.StartupPath);
            if (message == "1")
            {
        ...
        private void YWQuery()
        {
            try
            {
                ...
                string dh = gv_ZGSJ.GetRowCellValue(gv_ZGSJ.FocusedRowHandle, "zkdh").ToString();//获取当前选中行数量
                DataTable dt = null;
                dt = bll_Interface_FR.GetYWDXQ(dh,"1","").Tables[0];
